					...
					function( res ) {
						...
						res.json().then(
							function( data ) {
								...
								var quickViewPrice = quickViewContent ? quickViewContent.querySelector( '.price' ) : false;
								if ( quickViewPrice && data.bm_live_price ) {
									quickViewPrice.innerHTML = data.bm_live_price;
								}
