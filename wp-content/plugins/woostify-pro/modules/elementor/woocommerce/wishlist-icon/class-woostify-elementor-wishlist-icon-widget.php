...
class Woostify_Elementor_Wishlist_Icon_Widget extends Widget_Base {
	...
	public function render() {
		...
		$icon     = ( 'theme' === $settings['type'] ) ? apply_filters( 'woostify_header_wishlist_icon', 'ti-heart' ) : '';
		...
		<div class="woostify-wishlist-icon-widget">
			<a href="<?php echo esc_url( woostify_wishlist_page_url() ); ?>" class="tools-icon header-wishlist-icon icon-<?php echo esc_attr( $settings['position'] ); ?> <?php echo esc_attr( $icon ); ?>">
				<?php
