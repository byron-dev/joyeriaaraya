<?php
/**
 * Elementor filter by radio widget
 *
 ...
 * Class widget.
 */
class Woostify_Filter_Type_Radio extends Woostify_Filter_Base {
	/**
	 * Category
	 */
	...
	public function get_title() {
		return __( 'Woostify - Filter Radio', 'woostify-pro' );
	}
	...
	public function get_keywords() {
		return array( 'woostify', 'woocommerce', 'shop', 'product', 'filter', 'store', 'radio' );
	}
	...
	public function render() {
		...
		<div class="w-product-filter w-product-filter-type-radio" data-type="radio" data-source="<?php echo esc_attr( $data ); ?>">
			<?php $this->render_output( 'radio', $settings ); ?>
		</div>
		<?php
	}
}
Plugin::instance()->widgets_manager->register_widget_type( new Woostify_Filter_Type_Radio() );
