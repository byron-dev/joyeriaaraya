<?php
/**
 * Elementor filter by select widget
 *
 ...
 * Class widget.
 */
class Woostify_Filter_Type_Select extends Woostify_Filter_Base {
	/**
	 * Category
	 */
	...
	public function get_title() {
		return __( 'Woostify - Filter Select', 'woostify-pro' );
	}
	...
	public function get_keywords() {
		return array( 'woostify', 'woocommerce', 'shop', 'product', 'filter', 'store', 'select' );
	}
	...
	public function render() {
		...
		<div class="w-product-filter w-product-filter-type-select" data-type="select" data-source="<?php echo esc_attr( $data ); ?>">
			<select name="" class="w-product-filter-select-field">
				<?php $this->render_output( 'select', $settings ); ?>
			</select>
		</div>
		<?php
	}
}
Plugin::instance()->widgets_manager->register_widget_type( new Woostify_Filter_Type_Select() );
